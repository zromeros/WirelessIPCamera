...
path_file="C:\\Users\\-\\ProyectosESP32\\Repositorio\\WirelessIPCamera\\Wireless_Camera_Server\\sock\\stream.log"
format = 'XVID'
...
def receive_array_image():
    ...
    while True:
        ...
        if count_packs == 75: #cinco frames
            ...
            video = cv2.VideoWriter(video_name, fourcc, 5, (320, 240))
            stream(file_stream, video)
            os.remove(path_file)
            count_packs = 0
            count_stream += 1
